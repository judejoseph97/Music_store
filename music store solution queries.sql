...
/* Q8: Let's invite the artists who have written the most rock music in our dataset (only top 10). */
...
first find which artist earned most

then which customer spent the most on this artist
